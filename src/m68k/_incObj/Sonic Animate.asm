...
Sonic_Animate:				; XREF: Obj01_Control; et al
		...
		bclr	#staPush,obStatus(a0)	; clear pushing flag	;Mercury Pushing While Walking Fix	;Mercury Constants
...
@walkrunroll:
		addq.b	#1,d0			; is start flag = $FF
		bne.w	@rolljump		; if not, branch
		moveq	#0,d1			; is animation walking/running?
	...
	@noinvert:
		...
		eor.b	d1,d2
		or.b	d2,obRender(a0)
		btst	#staPush,obStatus(a0)	; is Sonic pushing something?	;Mercury Constants
