...
smpsClearPush macro
	if SonicDriverVer==1
		...
		message "Coord. Flag to clear S1 push block flag does not exist in S2 or S3 drivers. Complain to Flamewing to add it."
	endif
	endm
...
smpsStopSpecial macro
	if SonicDriverVer==1
		...
		message "Coord. Flag to stop special SFX does not exist in S2 or S3 drivers. Complain to Flamewing to add it. "
	endif
	endm
