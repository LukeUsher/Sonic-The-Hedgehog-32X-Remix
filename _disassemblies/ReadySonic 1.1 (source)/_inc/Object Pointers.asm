...
id_Obj03:		equ ((ptr_ObjectFall-Obj_Index)/4)+1
id_Obj04:		equ ((ptr_ObjectFall-Obj_Index)/4)+1

	if (SpinDashDustActive|InstaShieldActive)=1	;Mercury Spin Dash Dust, Insta-Shield
id_SonicEffects:	equ ((ptr_SonicEffects-Obj_Index)/4)+1
	else
id_Obj05:		equ ((ptr_ObjectFall-Obj_Index)/4)+1
	endc	;end Spin Dash Dust, Insta-Shield

id_Obj06:		equ ((ptr_ObjectFall-Obj_Index)/4)+1
id_Obj07:		equ ((ptr_ObjectFall-Obj_Index)/4)+1
